...
[项目文档](https://gmpd.netlify.app/) · [在线预览](https://topm.netlify.app) · [GitHub 仓库](https://github.com/XiangZi7/KM-Music-Player) · [API 文档](https://neteasecloudmusicapi.vercel.app/#/)
...
| **移动端** | 响应式 · 底部导航 · 播放器抽屉 · 列表/历史滑动切换 · 艺术家列表 |
